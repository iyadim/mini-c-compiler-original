...
_addition:
  ...
  cmpl $0, %eax            # Compare %eax to $3735928559
  setne %al                         # Perform '!='
  ...
  movl $-100, %eax                  # Set return value
  jmp ___stack_chk_fail              # Exit function
...
_main:
  ...
  movl $LC0, %ecx                   # Get addr of string literal 'additio...'
  ...
  movl $LC1, %ecx                   # Get addr of string literal 'Please ...'
  pushl %ecx                        # Push arg 1
  call _printf                      # Call printf()
  ...
  movl $LC2, %edx                   # Get addr of string literal 'a has N...'
